...
def index():
    ...
    if(request.method=="POST"):
        request_data = request.config.data #getting the response data
        print(request_data)
        request_data = request_data.decode('utf-8') #converting it from json to key value pair
        picUrl = request_data #assigning it to name
